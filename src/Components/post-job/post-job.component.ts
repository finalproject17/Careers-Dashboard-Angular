...
export class PostJobComponent {
  jobForm: FormGroup;
  skillsList: string[] = ['JavaScript', 'HTML', 'CSS', 'Angular', 'React', 'Node.js', 'Python', 'Next.js', 'vue'];
  requirementsList: string[] = ['Bachelor\'s Degree', '2+ years experience', 'Team player', 'Good communication skills'];
    ...
    constructor(private fb: FormBuilder, private hhtpClient :HttpClient) {
      this.jobForm = this.fb.group({
        ...
        JobTitle: new FormControl('', [Validators.required, Validators.maxLength(100), Validators.minLength(3)]),
        ...
        companyId: new FormControl('6664032cff0e9fda232e5cc4', [Validators.required])
      });
    }
    ...
    addJob() {
      ...
      this.hhtpClient.post<any>(`${environment.baseUrl}/jobs/create`, jobData).subscribe({
        next: (response) => {
